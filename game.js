window.onload = function() {
    ...
    function create () {
      ...
      game.physics.p2.restitution = 0.9;
        ...
        //attempting to enable impact events
        ...
        // game.physics.p2.enable(allPieces, Phaser.Physics.ARCADE);
        allPieces.allowGravity = false;
        allPieces.collideWorldBounds = true;
        console.log(b1Queen.body);
        // game.physics.overlap( item, item , overlapHandler, null, this);
